...
void UBlueprintMergeLibrary::ResolveReference(UObject* WorldContextObject, UObject* Target, UDataTable* RulesDataTable, const FString& AssetDirectoryPath)
{
	...
	TMap<FName, FPropertyData> PropertyMap = BuildPropertyMap(Target);
	...
	for (const FReferenceResolveRulesRow* Row : Rows)
	{
		...
		FName PropertyPath = FName(*Row->PropertyPath);
